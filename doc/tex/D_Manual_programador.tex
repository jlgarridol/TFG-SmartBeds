...
En este apéndice se explicarán todas las partes necesarias para poder entender los componentes software que existen así como como desarrollar aplicaciones siguiendo la \textit{API REST} provista.
